  ...
  render() {
    if (this.props.data) {
      ...
      var competitions = this.props.data.competitions.map(function (competitions) {
        return (
          <div key={competitions.company}>
            <h3>{competitions.company}</h3>
            <p className="info">
              {competitions.title}
              <span>&bull;</span> <em className="date">{competitions.years}</em>
            </p>
      ...
      var awards = this.props.data.awards.map(function (awards) {
        return (
          <div key={awards.company}>
            <h3>{awards.company}</h3>
            <p className="info">
              {awards.title}
              <em className="date">{awards.years}</em>
            </p>
    ...
    return (
      <section id="resume">
        ...
        <div className="row competitions">
          ...
          <div className="nine columns main-col">{competitions}</div>
        </div>
